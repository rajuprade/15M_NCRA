...
typedef enum { INFO=1, WARNING2=2, WARNING3=3, CRITICAL4=4,CRITICAL5=5 } alarmlevels;
...
#define  MAXDATA 128   // Modified on 12/09/2011, to make compatible with rabbit //
#define  DATALEN 64

#ifdef _DATASERVER_
#define DATAPKT 4096
#else
#define DATAPKT DATALEN
#endif
