	...
	subroutine ep2daj(epoch,year,month,day,fday)
...
C	write(*,*) 'ep2da' ,year, dayno
	...
	if(dayno.le.1.0)then
	    month=1
	    day=1
	    go to 10
	endif

C     To avoid leap Yr problem
C     Instead of 365.0 make it 0.99990 * 365.2425 

	if(dayno.ge.365.2059) then
	    month=12
            day=31
            write(*,*) 'Assigning day' ,day
	    go to 10
	endif
