...
void gstrgsts(double *, double*, double *, double*, double*, double *, double *,char *); 
...
// All the variables are expressed in terms of radians
	...
	gstrgsts(lat,longd,el,&sss->rad,&sss->decd,gstr,gsts,&val->flag);
...
void gstrgsts(double *lat, double *longd, double *el, double *ra, double *dec, double *gstr, double *gsts,char *flag) 
    {
/*
C*************************************************************************
C
