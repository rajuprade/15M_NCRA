...
lstdata Lstdata;
 ...
 char srcInfo[][12] = {"3C286","13h28m49.65s", "+30d45'58.6", "1950.0"};
 char timeInfo[][12] = {"11", "03", "21", "10", "56", "30","-74.05"};
 calculatelst(timeInfo, srcInfo, Lstdata);
...
/*
   ...
   int mode; */
/* mode 10 Reference to Target Epoch, 11 Precesses the coordinates */
/*
   if(argc == 1)  {
...
*/
        // Calculation date to Target MJD */ 
/*  
