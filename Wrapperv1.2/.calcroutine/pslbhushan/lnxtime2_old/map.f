      SUBROUTINE slamap (RM, DM, PR, PD, PX, RV, EQ, DATE, RA, DA)
*+
*     - - - -
*      M A P
*     - - - -
*  Note : ORIGINAL slamap Routine Name is sla_MAP but C-interface
*         was giving problem hence changed name to slamap - JPK
*         3/12/2010 JPK
