...
#include "libvlba.h"
  ...
  void prcesj2 (t_nowp, pos_J2000, pos_mean)
    double *t_nowp;            /*  target time with respect to J2000,
                             **        in Julian centuries                  */
    double *pos_J2000;     /*  (input) position vector:  direction cosines
                             **    of position at standard epoch J2000      */
    double *pos_mean;      /*  (output) position vector:  direction cosines
                             **    of MEAN position at target epoch         */
/*
%%  General precession  FROM standard epoch J2000  TO an arbitrary date.
---
    Definition of t_now:
    ...
    SOURCES:
        United States Naval Observatory:  Circular # 163 (1981 Dec 10),
            page A2.
...
TESTED:  7 Jan 86, D. King.  Seems to do reasonable things to input positions;
...
++$  Audit Trail
    ...
    1.0   86jan16   D. King   Minor documentation improvement.
    1.0   86jan21   D. King   Minor documentation correction -- code unchanged.
    1.0   86feb04   D. King   Documented additional testing -- code unchanged.
    1.0   86mar06   D. King   Corrected documentation typo -- code unchanged.
    1.0   86Apr29   D. King   Corrected documentation delimiter -- code unch.
--$
-*/
#define version 1.0
 ...
 
{
    double
        zeta_A,              /*  }                                          */
        zed_A,               /*  }-  Equatorial precession parameters       */
        theta_A,             /*  }                                          */
