stime( ffangle, format_str, out_string )
    char   *ffangle;           /*  angle to be converted to string        */
...
!!!! sangle_ has been patched to give hours, minutes and seconds.
	In the following documentaion read hms in the place of d'"
...
#define HALF_SEC     0.000002424068405548/15.
 
#define UNSIGNED 0L
#define TRUE   1
#define FALSE  0
 
#define SEC_DEFAULT  2
#define DEG_DEFAULT  3
 
#define MIN_WIDTH  -2L
#define SEC_WIDTH  -2L
 
#define UNITS_CHARS "hms"
