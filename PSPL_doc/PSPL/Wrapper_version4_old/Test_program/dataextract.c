...
char *get_cmdparam(char *ptr)
{
  ...
  {
    z++;
  }while(!((str[z]=='<') && (str[z+1]=='/') && (str[z+2]=='D'||str[z+2]=='d')&& (str[z+3]=='A'||str[z+3]=='a') && (str[z+4]=='T'||str[z+4]=='t')&& (str[z+5]=='A'||str[z+5]=='a') && (str[z+6]=='>')));
  ...
  while(y<z)
  {
    do
    {
      ix++;
      //printf("%c",str[ix]);
    }while(!((str[ix]=='>') && (str[ix-1]=='E'||str[ix-1]=='e')&& (str[ix-2]=='U'||str[ix-2]=='u')&& (str[ix-3]=='L'||str[ix-3]=='l')&&  (str[ix-4]=='A'||str[ix-4]=='a')&&  (str[ix-5]=='V'||str[ix-5]=='v')&& (str[ix-6]=='<')&& (ix<z)));
    ...
    do
    {
      iy++;
      //printf("%c",str[iy]);
    }while(!((str[iy]=='<') && (str[iy+1]=='/') && (str[iy+2]=='V'||str[iy+2]=='v')&& (str[iy+3]=='A'||str[iy+3]=='a') && (str[iy+4]=='L'||str[iy+4]=='l')&& (str[iy+5]=='U'||str[iy+5]=='u') && (str[iy+6]=='E'||str[iy+6]=='e')&& (str[iy+7]=='>')&&(iy<z)));
